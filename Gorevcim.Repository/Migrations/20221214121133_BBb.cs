        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Base64Content = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreateUserId = table.Column<int>(type: "int", nullable: true),
                    UpdateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdateUserId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductFeatures_Images_ImagesId",
                        column: x => x.ImagesId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, "AS123", 1, "123AS", new DateTime(2022, 12, 14, 15, 11, 32, 793, DateTimeKind.Local).AddTicks(7498), null, new DateTime(2022, 12, 14, 15, 11, 32, 793, DateTimeKind.Local).AddTicks(7485), "hghghggh", "dlld", null, null, null, null, null, null, null, null, null, 0, "ad", "sdf", "sdsdf", "Test Ürün1", 10, 15, 1, "dfsd", new DateTime(2022, 12, 14, 15, 11, 32, 793, DateTimeKind.Local).AddTicks(7501), null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductFeatures_ImagesId",
                table: "ProductFeatures",
                column: "ImagesId");
